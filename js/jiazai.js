$(document).ready(function(){
    ...
    //载入侧边栏
    var youce = '<div class="column3_1"><div class="column3_biaoti"><p id="gaikuang">协会概况</p></div><ul class="column3_tiao"><a href="xhgk.html" target="blank" class="button button-glow button-rounded button-raised button-primary" id="gaikuang_anniu">协会介绍</a><a href="xhzc.html" target="blank" class="button button-glow button-rounded button-raised button-primary" id="gaikuang_anniu">协会章程</a><a href="xhld.html" target="blank" class="button button-glow button-rounded button-raised button-primary" id="gaikuang_anniu">协会领导</a><a href="glzd.html" target="blank" class="button button-glow button-rounded button-raised button-primary" id="gaikuang_anniu">管理制度</a><a href="#" target="blank" class="button button-glow button-rounded button-raised button-primary" id="gaikuang_anniu2">会员单位</a></ul><div class="column3_biaoti"><p id="hangye">行业管理</p></div><ul class="column3_tiao"><a href="#" target="blank" id="yuan"><img src="img/icon1.png" ><span>行业研究</span></a><a href="#" target="blank" id="yuan"><img src="img/icon2.png" ><span>行业监督</span></a><a href="#" target="blank" id="yuan"><img src="img/icon3.png" ><span>等级评定</span></a><a href="#" target="blank" id="yuan"><img src="img/icon4.png" ><span>学习培训</span></a></ul><div class="column3_biaoti"><p id="lianxi">联系我们</p><p id="lianxiwenzi">热线：13980756471<br>邮箱：stsams@163.com</p></div></div>'
