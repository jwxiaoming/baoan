$(document).ready(function(){
    //载入头部
    var toubu ='<div class="header"> <div class="header_top"> <img src="img/logo.png" id="logo"> <p>成都市安保技术与服务协会</p> </div> <div class="title"> <a href="index.html">网站首页</a> <a href="index.html">加入收藏</a> <a href="index.html">联系我们</a> <form action="" method="post"> <input type="text" style="border-radius: 10px;width: 120px;"> <input type="submit" style="margin-left:5px;" value="站内搜索"> </form> </div> </div> <div class="nav"> <div class="menu"> <li> <a href="index.html">网站首页</a> </li> <li> <a href="xhgk.html">协会概况</a> </li> <li> <a href="tzgg.html">通知公告</a> </li> <li> <a href="xhsx.html">协会时讯</a> </li> <li> <a href="#">党政建设</a> </li> <li> <a href="#">企业风貌</a> </li> <li> <a href="#">媒体宣传</a> </li> <li> <a href="#">信息公示</a> </li> <li> <a href="#">学习培训</a> </li> <li> <a href="#">创先争优</a> </li> <li> <a href="flfg.html">法律法规</a> </li> <li> <a href="#">会员服务</a> </li> <li> <a href="#">行业管理</a> </li> <li> <a href="#">行业研究</a> </li> <li> <a href="hydt.html">行业动态</a> </li> <li> <a href="#">行业监督</a> </li> <li> <a href="#">保安服务</a> </li> <li> <a href="#">安保技术</a> </li> <li> <a href=#">安防设备</a> </li> <li> <a href="#">等级评定</a> </li> <li> <a href="#">企业招聘</a> </li> <li> <a href="#">联系我们</a> </li> </div> </div>';
